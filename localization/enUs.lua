...
MPOWA_CHECKBUTTON_ENEMYONLY_TOOLTIP = "Check this to show the aura only if you are targeting an enemy. Use with 'Ability not ready' and 'Invert' to show abilities that you can cast only on an enemy. Example spell: Judgement"
MPOWA_CHECKBUTTON_STANCE_TOOLTIP = "Check this to show an aura for a current stance you are in. It needs 'Abilty not ready' and 'Invert' checked in order to function"
MPOWA_CHECKBUTTON_STANCE = "Stance"
MPOWA_CHECKBUTTON_AUTO_UPDATE= "Auto Update"
MPOWA_CHECKBUTTON_AUTO_UPDATE_TOOLTIP = "Use this with 'Ability not ready' to update spell slot assignment automatically. Uncheck to update slots manually by doing RELOADUI command after you move spells - not recommended."
