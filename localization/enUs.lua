...
MPOWA_EDITBOX_NAME = "Exact name of the Buff or Ability:"
...
MPOWA_CHECKBUTTON_SHOWCOOLDOWN = "Ability not ready"
MPOWA_CHECKBUTTON_SHOWCOOLDOWN_TOOLTIP = "Check this to show the icon if the ability is on cooldown, out of range or NOT available. Use together with 'Invert' to show if action is available. Example spell: Power Word: Shield. Use with 'Enemy Only' to show icon only if you are targeting an enemy, example: Judgement. Spell must be on one of the ActionBars"
MPOWA_CHECKBUTTON_ABILITY_AVAILABLE = "Ability available"
MPOWA_CHECKBUTTON_ABILITY_AVAILABLE_TOOLTIP = "Check this to show the aura if the ability is available and in range"
MPOWA_CHECKBUTTON_ENEMYONLY = "Enemy Only"
MPOWA_CHECKBUTTON_ENEMYONLY_TOOLTIP = "Check this to show the aura only if you are targeting an enemy. Use with 'Ability available' to show abilities that you can cast only on an enemy. Example spell: Judgement"
MPOWA_CHECKBUTTON_STANCE_TOOLTIP = "Check this to show an aura for a current stance you are in, do NOT put name of stance in the text box, it will be entered when you check the box."
MPOWA_CHECKBUTTON_STANCE = "Stance"
MPOWA_CHECKBUTTON_AUTO_UPDATE= "Auto Update"
MPOWA_CHECKBUTTON_AUTO_UPDATE_TOOLTIP = "Use this with 'Ability available' to update spell slot assignment automatically. Uncheck to update slots manually by doing RELOADUI command after you move spells - not recommended."
...
MPOWA_TEXT_SUPPORTING = "Further development by Berranzan "
