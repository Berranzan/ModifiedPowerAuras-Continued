...
MPOWA_CHECKBUTTON_ENEMYONLY_TOOLTIP = "Check this to show the icon only if you are targeting an enemy. Use with 'Ability not ready' and 'Invert' to show abilities that you can cast only on an enemy. Example spell: Judgement"
